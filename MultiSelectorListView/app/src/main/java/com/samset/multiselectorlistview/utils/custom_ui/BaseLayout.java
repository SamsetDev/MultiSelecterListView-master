...
package com.samset.multiselectorlistview.utils.custom_ui;
...
import com.samset.multiselectorlistview.R;
...
public class BaseLayout extends ViewGroup {
	...
	public BaseLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.BaseLayout, defStyle, 0);

        try {
            int index = a.getInt(R.styleable.BaseLayout_android_gravity, -1);
            if(index > 0) {
                setGravity(index);
            }
        } finally {
	...
	public static class LayoutParams extends MarginLayoutParams {
		...
		public LayoutParams(Context c, AttributeSet attrs) {
			...
			TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.BaseLayout_Layout);

            try {
                gravity = a.getInt(R.styleable.BaseLayout_Layout_android_layout_gravity, -1);
            } finally {
                a.recycle();
            }
		}
